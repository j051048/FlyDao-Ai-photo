...
export const TRANSLATIONS: Record<string, Translation> = {
    zh: {
        ...
        baseUrlPlaceholder: "输入 Base URL (默认: https://proxy.flydao.top/v1)",
        modePreset: "大师预设",
        modeCustom: "自定义风格",
        ...
        // Subscription
        upgradeToPro: "升级到 Pro 版 🚀",
        subscribeTitle: "解锁无限可能",
        subscribeSubtitle: "成为 Pro 用户，释放 AI 的全部潜力",
        perMonth: "/ 月",
        feature1: "无限次生成图片",
        feature2: "解锁 Gemini 3 Pro 高级模型",
        feature3: "更快的生成速度",
        feature4: "尊贵 Pro 徽章",
        subscribeBtn: "立即订阅 ($10)",
        restorePurchase: "恢复购买",
        paymentSuccessTitle: "支付成功！",
        paymentSuccessDesc: "欢迎加入 Pro 俱乐部。您现在可以享受所有高级功能。",
        returnHome: "返回首页",
        paymentCancelTitle: "支付已取消",
        paymentCancelDesc: "您取消了支付流程。如果您遇到问题，请随时联系我们。",
    },
    en: {
        ...
        baseUrlPlaceholder: "Enter Base URL (Default: https://proxy.flydao.top/v1)",
        ...
        subscribeTitle: "Unlock Potential",
        subscribeSubtitle: "Become a Pro member and unleash the full power of AI",
        perMonth: "/ month",
        feature1: "Unlimited Generations",
        feature2: "Unlock Gemini 3 Pro Model",
        feature3: "Faster Processing Priority",
        feature4: "Exclusive Pro Badge",
        subscribeBtn: "Subscribe Now ($10)",
        restorePurchase: "Restore Purchase",
        paymentSuccessTitle: "Payment Successful!",
        paymentSuccessDesc: "Welcome to the Pro club. You can now access all premium features.",
        returnHome: "Return Home",
        paymentCancelTitle: "Payment Cancelled",
        paymentCancelDesc: "You cancelled the payment process. Feel free to try again later.",
    }
};
